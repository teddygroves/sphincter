/* Model for answering question 2. Version with pressure effects
   and no age effects, aiming to answer the question whether these
   are simply due to the higher average pressure of adult mice. 
*/
