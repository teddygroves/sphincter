...
This does not mean that there were no significant treatment effects, but just
that these effects did not depend on age or vessel type. @fig-whisker-treatment-effects
shows the marginal posterior distributions for hypertension and ablation effects
relative to the baseline, showing a clear effect in both cases.
